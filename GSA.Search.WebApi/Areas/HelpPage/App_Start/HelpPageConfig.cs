...
#endif
using GSA.Search.WebApi.Models;

namespace GSA.Search.WebApi.Areas.HelpPage
{
    /// <summary>
    ...
    public static class HelpPageConfig
    {
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "GSA.Search.WebApi.Areas.HelpPage.TextSample.#ctor(System.String)",
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            config.SetSampleForType("FirstName=sample1&LastName=sample2&BossId=sampleBoss&Email=sample@sample.se &AdTitle=sample3&OwnTitle=sample4&Seat=sample5&UserName=sample6&Phone=1234&Mobile=1234&Office=sample7 &Company=sample8&PersonalInfo=sample9&Active=true&CostCentre=15", new MediaTypeHeaderValue("application/x-www-form-urlencoded"), typeof(SimpleUser));
